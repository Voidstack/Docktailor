 ...
 * <p>
 * Coordinate system is similar to SVG one, its (0,0) origin is located at the upper left corner, unless modified by
 * setOrigin().
 * <p>
 * Angles are measured in radians. For rotations, positive angle corresponds to clockwise direction, negative - to
 * counter-clockwise.
 * <p>
 * Stroke and fill parameters are set at the moment of creation of a stroke or a shape.  Subsequent setting of those
 * parameters has no effect on existing elements.
 */
