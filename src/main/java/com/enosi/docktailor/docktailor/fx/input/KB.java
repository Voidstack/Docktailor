...
import com.enosi.docktailor.docktailor.fx.input.internal.KMod;
...
/**
 * Key Binding represents a key press (or release, or typed) event with the optional modifier keys.
 */
public class KB {
    /**
