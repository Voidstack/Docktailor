 ...
 * <p>
 * border:  -fx-border-color, -fx-border-insets, -fx-border-radius, -fx-border-style, -fx-border-width,
 * -fx-border-image-insets, -fx-border-image-repeat, -fx-border-image-slice, -fx-border-image-source,
 * -fx-border-image-width background:  -fx-background-color, -fx-background-image, -fx-background-insets,
 * -fx-background-position, -fx-background-radius, -fx-background-repeat, -fx-background-size
 * <p>
 * text input: -fx-highlight-fill 0x0096c9ff -fx-highlight-text-fill 0xffffffff
 * <p>
 * order or Insets: TRBL
 */
public class StandardFxProperties {
     ...
     * bottom-right | baseline-left | baseline-center | baseline-right
     */
    ...
    /**
     * A series of paint values or sets of four paint values, separated by commas. For each item in the series, if a
     * single paint value is specified, then that paint is used as the border for all sides of the region; and if a set
     * of four paints is specified, they are used for the top, right, bottom, and left borders of the region, in that
     * order. If the border is not rectangular, only the first paint value in the set is used.
     */
     ...
     * first width value is used. Each item in the series of widths applies to the corresponding item in the series of
     * border colors.
     */
    ...
    public static FxCssProp fitToHeight(boolean x) {
        return new FxCssProp("-fx-fit-to-height", x);
    }

    public static FxCssProp fitToWidth(boolean x) {
        return new FxCssProp("-fx-fit-to-width", x);
    }
    ...
    public static FxCssProp labelPadding(double top, double right, double bottom, double left) {
        return new FxCssProp("-fx-label-padding", spaces(top, right, bottom, left));
    }
    ...
    public static FxCssProp opacity(double x) {
        return new FxCssProp("-fx-opacity", x);
    }
    ...
    public static FxCssProp padding(int top, int right, int bottom, int left) {
        return new FxCssProp("-fx-padding", spaces(top, right, bottom, left));
    }
    ...
    public static FxCssProp prefHeight(double x) {
        return new FxCssProp("-fx-pref-height", x);
    }
    ...
    public static FxCssProp strokeWidth(double x) {
        return new FxCssProp("-fx-stroke-width", x);
    }
    // T
    ...
    public static FxCssProp translateX(double x) {
        return new FxCssProp("-fx-translate-x", x);
    }

    public static FxCssProp translateY(double x) {
        return new FxCssProp("-fx-translate-y", x);
    }
