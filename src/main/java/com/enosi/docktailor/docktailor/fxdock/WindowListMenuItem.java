...
/**
 * WindowListMenuItem is a separator menu item which automatically inserts a list of window selection menu items after
 * itself, and updates this list dynamically.
 */
