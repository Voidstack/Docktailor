...
import com.enosi.docktailor.common.log.internal.ConsoleAppender;
...
public class Log {
    ...
    /**
     * prints to stderr - do not leave in production code. this is not a replacement for proper logging.
     */
