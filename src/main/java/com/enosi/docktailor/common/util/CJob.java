...
public abstract class CJob implements Runnable {
    ...
    /**
     * Signal to finish all currently running jobs and then shitdown the executor. An exception will be thrown by
     * submit() if a job is submitted after this method is called.
     */
