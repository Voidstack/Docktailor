...
public class Hex {
    ...
    /**
     * Parses input string as a hexadecimal byte array, ignoring all non-hex symbols. Throws an exception if the number
     * of hex symbols is not even.
     */
    ...
    /**
     * Parses input string as a hexadecimal byte array, ignoring all non-hex symbols, starting at the specified offset
     * and using len characters. Throws an exception if the number of hex symbols is not even.
     */
