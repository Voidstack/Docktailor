...
//		".tiff"
    ...
    /**
     * returns path to root, including the file name. returns null if file and root are unrelated.
     * <p>
     * example: root = "C:\\A\\B" file = "C:\\A\\B\\C\\1.jpg" result = "C/1.jpg"
     */
    ...
    /**
     * returns path to root, excluding the file name. example: root = "C:\\A\\B" file = "C:\\A\\B\\C\\1.jpg" result =
     * "C"
     */
    ...
    /**
     * deletes file or folder, recursing into subdirectories when necessary.  returns true if operation succeeded in
     * deleting.
     */
     ...
     * characters. This is the same as often found on Dos/Unix command lines. The check is case-sensitive always.
     * <pre>
