...
public class CMultiMap<K, V> {
    ...
    /**
     * Adds a value to the list of items stored under the specified key. Duplicate values are permitted. Returns true if
     * the map changed as a result of this call.
     */
