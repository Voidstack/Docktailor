 ...
 * several pieces of information to the encoder. In the "higher level" methods such as encodeBytes( bytes, options ) the
 * options parameter can be used to indicate such things as first gzipping the bytes before encoding them, not inserting
 * linefeeds, and encoding using the URL-safe and Ordered dialects.</p>
 *
 * <p>Note, according to <a href="http://www.faqs.org/rfcs/rfc3548.html">RFC3548</a>,
 * Section 2.1, implementations should not add line feeds unless explicitly told to do so. I've got Base64 set to this
 * behavior now, although earlier versions broke lines by default.</p>
 *
...
public class Base64 {
     ...
     **/
    private final static byte[] STANDARD_DECODE_ALPHABET =
            {
     ...
     */
    private final static byte[] URL_SAFE_DECODE_ALPHABET =
            {
                    -9, -9, -9, -9, -9, -9, -9, -9, -9,                 // Decimal  0 -  8
                    -5, -5,                                      // Whitespace: Tab and Linefeed
                    -9, -9,                                      // Decimal 11 - 12
     ...
     */
    private final static byte[] ORDERED_DECODE_ALPHABET =
            {
                    -9, -9, -9, -9, -9, -9, -9, -9, -9,                 // Decimal  0 -  8
                    -5, -5,                                      // Whitespace: Tab and Linefeed
                    -9, -9,                                      // Decimal 11 - 12
    ...
    public static byte[] encodeBytesToBytes(byte[] source) {
        try {
            ...
            assert false : "IOExceptions only come from GZipping, which is turned off: " + e.getMessage();
        }
        return null;
    }
    ...
    public static void encodeToFile(byte[] dataToEncode, String filename) throws Exception {
        ...
        try {
            bos = new Base64OutputStream(new FileOutputStream(filename), Base64.ENCODE);
